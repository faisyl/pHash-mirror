...
ACLOCAL = ${SHELL} /homes/ycli/ycli-data/pHash-work/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /homes/ycli/ycli-data/pHash-work/missing --run autoconf
AUTOHEADER = ${SHELL} /homes/ycli/ycli-data/pHash-work/missing --run autoheader
AUTOMAKE = ${SHELL} /homes/ycli/ycli-data/pHash-work/missing --run automake-1.12
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /homes/ycli/ycli-data/pHash-work/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.9.6
abs_builddir = /homes/ycli/ycli-data/pHash-work
abs_srcdir = /homes/ycli/ycli-data/pHash-work
abs_top_builddir = /homes/ycli/ycli-data/pHash-work
abs_top_srcdir = /homes/ycli/ycli-data/pHash-work
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /homes/ycli/ycli-data/pHash-work/install-sh
